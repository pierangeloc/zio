...
/**
 * Title: Understanding ThreadLocal in Async Code Description: This example
 * demonstrates the problem with using Java ThreadLocal in asynchronous code and
 * why ThreadLocalBridge is needed. Run: sbt "threadlocal-bridge/runMain
 * threadlocalbridge.Concept1Example"
 */
